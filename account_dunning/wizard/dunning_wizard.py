...
class account_dunning_wizard(osv.osv_memory):
    def create_reminders(self, cr, uid, ids, context=None):
        ...
        profiles = profile_obj.browse(
            cr, uid, profile_obj.search(cr, uid, []), context=context
        )
        ...
        for wizard in self.browse(cr, uid, ids):
            ...
            for customer in customers:
                ...
                if not customer.noremind:
                    ...
                    if (
                        not commercial_partner.credit
                        or commercial_partner.credit > commercial_partner.debit
                        or reminder_id
                    ):
                        ...
                        for inv in invoice_obj.browse(cr, uid, invoice_ids):
                            ...
                            if (
                                ...
                                if inv.state == "open":
                                    ...
                                    if (
                                        profile_line
                                        and profile_line.payment_no_dunning
                                        and inv.residual > 0
                                        and inv.residual < inv.amount_total
                                    ):
                                        profile_line = None
                                    ...
                                    invoice_obj.write(
                                        ...
                                        inv.id,
                                        {
                                            "profile_line_id": profile_line
                                            and profile_line.id
                                            or None,
                                            "dunning_date": wizard.date,
                                        },
                                        context,
                                    )
                                    ...
                                    if profile_line and inv.residual:
                                        ...
                                        if not reminder_line_id:
                                            ...
                                            lines.append(
                                                (1, reminder_line_id, line_values)
                                            )

                                        # determine max profile
                                        if max_profile_line:
                                            if (
                                                max_profile_line.sequence
                                                < profile_line.sequence
                                            ):
                        ...
                        if max_profile_line:
                            ...
                            if reminder_id:
                                reminder_obj.write(
                                    cr, uid, reminder_id, values, context
                                )
                            else:
