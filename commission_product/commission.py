...
class commission_line(osv.Model):
    @api.cr_uid_context
    def _validate_product_commission(
        self, cr, uid, values, obj=None, company=None, context=None
    ):
        return values

    @api.cr_uid_context
    def _get_product_commission(
        self,
        cr,
        uid,
        name,
        ...
        for commission in commission_obj.browse(
            cr, uid, commission_ids, context=context
        ):
            ...
            if commission.commission_percent:
                ...
                entry = self._validate_product_commission(
