...
class sale_shop(osv.Model):
    ...
    _columns = {
        "country_ids": fields.many2many(
            "res.country", "sale_shop_country_rel", "shop_id", "country_id", "Countries"
        )
    }
...
class sale_order(osv.Model):
    ...
    def onchange_partner_id(self, cr, uid, ids, partner_id, context=None, shop_id=None):
        res = super(sale_order, self).onchange_partner_id(
            cr, uid, ids, partner_id, context=context, shop_id=shop_id
        )
        ...
        if partner_id:
            ...
            if partner:
                ...
                if not shop_id or not shop_obj.search(
                    cr,
                    uid,
                    [
                        ("id", "=", shop_id),
                    ...
                    value["shop_id"] = shop_obj.search_id(
                        cr,
                        uid,
                        [
                            "|",
