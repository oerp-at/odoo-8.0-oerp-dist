...
class BinaryExtension(Binary):
    ...
    def saveas(self, model, field, id=None, filename_field=None, **kw):
        ...
        return super(BinaryExtension, self).saveas(
            model, field, id=id, filename_field=filename_field, **kw
        )
    ...
    def upload_attachment(self, callback, model, id, ufile):
        ...
        try:
            ...
            # save file
            attachment_id = att_obj._save_file(
                request.cr, request.uid, None, values, request.context
            )

            # return args
            args = {"filename": ufile.filename, "id": attachment_id}
