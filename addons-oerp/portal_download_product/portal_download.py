...
class portal_download(models.Model):
    ...
    product_id = fields.Many2one(
        "product.product", "Product", ondelete="restrict", copy=True, index=True
    )
    ...
    def _name_search(
        ...
        return super(portal_download, self)._name_search(
            cr, user, name, args, operator, context, limit, name_get_uid
        )
