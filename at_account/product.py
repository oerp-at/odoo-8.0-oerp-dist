...
class product_template(osv.Model):
    ...
    def _get_account_expense_standard(
    ...
    _columns = {
        "account_income_standard_id": fields.function(
            _get_account_income_standard,
            method=True,
            string="Standard income account",
            type="many2one",
            relation="account.account",
        ),
        "account_expense_standard_id": fields.function(
            _get_account_expense_standard,
            method=True,
            string="Standard expense account",
            type="many2one",
            relation="account.account",
        ),
    }
