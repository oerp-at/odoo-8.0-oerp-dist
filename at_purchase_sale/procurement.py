...
class procurement_order(osv.osv):
    ...
    def _get_po_line_values_from_proc(
        ...
        res = super(procurement_order, self)._get_po_line_values_from_proc(
        ...
        for procurement in self.browse(cr, uid, ids, context=context):
            ...
            if not partner:
                ...
                if available_draft_po_ids:
                    ...
                    # crate new origin
                    po_origins = set(
                        self._re_split_po_origin.split(po_rec.origin or "")
                    )
                    po_origins |= set(
                        self._re_split_po_origin.split(procurement.origin or "")
                    )
                    ...
                    available_po_line_ids = po_line_obj.search(
                        ...
                        [
                            ...
                            ("sale_line_id", "=", line_vals.get("sale_line_id", False)),
                        ],
                        context=context,
                    )
                    ...
                    name = (
                        seq_obj.get(cr, uid, "purchase.order", context=context)
