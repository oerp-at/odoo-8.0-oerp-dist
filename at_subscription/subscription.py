...
class subscription_document_fields(osv.osv):
    ...
    _columns = {
        "value": fields.selection(
            [("false", "False"), ("date", "Current Date"), ("text", "Text")],
            "Default Value",
            size=40,
...
class subscription_subscription(osv.osv):
    ...
    _columns = {
        "doc_id": fields.many2one(
            "subscription.document", "Document type", required=True
        ),
    ...
    _defaults = {"doc_source_model": _get_source_model}
